...
_action = _board addAction ["<t color='#00ff88'>Humanitarian Aid</t>", "instructions\text\humanitarianAid.sqf", [], 10, true, true];
...
while { true } do { sleep 60; _board setpos _boardpos; _board setvectorup [0,0,1]; _board setdir 145; };
