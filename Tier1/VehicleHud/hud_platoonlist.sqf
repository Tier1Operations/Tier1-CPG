	...
	// {
			{
				...
				if ((_name == "Charlie Lead") || (_name == "Charlie 1") || (_name == "Charlie 2") || (_name == "Charlie 3")) then { _text = _text + format ["<t size='1.4' shadow='2' color='#FF8000'>%1</t><br/>", _name]; };
				if (_name == "Shadow 1") then { _text = _text + format ["<t size='1.4' shadow='2' color='#666666'>%1</t><br/>", _name]; };
				//if (_name == "Fox 1") then { _text = _text + format ["<t size='1.4' Shadow='2' color='#ff2222'>%1</t><br/>", _name]; };
				//if (_name == "Fox 2") then { _text = _text + format ["<t size='1.4' Shadow='2' color='#2255ff'>%1</t><br/>", _name]; };
				//if (_name == "Hammer 1") then { _text = _text + format ["<t size='1.4' Shadow='2' color='#ff8800.'>%1</t><br/>", _name]; };
				if (_name == "Reaper 1") then { _text = _text + format ["<t size='1.4' shadow='2' color='#00ff00'>%1</t><br/>", _name]; };
				if (_name == "Raptor 1") then { _text = _text + format ["<t size='1.4' shadow='2' color='#CC0000'>%1</t><br/>", _name]; };
