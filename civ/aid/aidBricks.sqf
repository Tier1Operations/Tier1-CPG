...
_bricks = createVehicle ["Land_Bricks_V1_F", _spawnpos1, [], 0, "CAN_COLLIDE"];
_bricks allowdamage false;

message = parsetext "<br/><img image='civ\pix\aidBricks.jpg' size='5' align='center'/><br/><br/><t align='center' size='2'>Aid Request</t><br/><br/><t align='center' size='1.5' color='#00ff88'>Bricks</t><br/><br/><t align='center'>A civilian says his town needs contruction material.<br/>Bring here a pile of bricks to help with the village repairs.</t><br/><br/>Be advised: the enemy will try to stop you from delivering the aid.<br/>  "; 
...
_aidmrk setMarkerText ' Bricks needed';
...
message = parseText format ["<br/><img image='civ\pix\aidBricks.jpg' size='5' align='center'/><br/><br/>
	<t align='center' size='1.5'>Humanitarian Aid</t><br/><br/>
	<t align='center' size='1.5' color='#01df01'>Delivered</t><br/><br/>
	The construction material has been delivered to the population that has requested it. This is a small but important step towards the stabilization of the area.
	<br/>Good job everyone.<br/><br/>At the moment, the population %1 you.<br/>   ", _judgement];

[message,"hintThis"] spawn BIS_fnc_MP;

_aidmrk setMarkerColor "ColorGreen";
_aidmrk setMarkerText " Bricks Delivered";
