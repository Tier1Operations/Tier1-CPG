...
_bricks = createVehicle ["Land_Sacks_goods_F", _spawnpos1, [], 0, "CAN_COLLIDE"];
_bricks allowdamage false;

message = parsetext "<br/><img image='civ\pix\aidFood.jpg' size='5' align='center'/><br/><br/><t align='center' size='2'>Aid Request</t><br/><br/><t align='center' size='1.5' color='#00ff88'>Food</t><br/><br/><t align='center'>A civilian says his town needs food.<br/>Bring here some sacks of food to sustain the population.</t><br/><br/>Be advised: the enemy will try to stop you from delivering the aid.<br/>  "; 
...
_aidmrk setMarkerText ' Food needed';
...
message = parseText format ["<br/><img image='civ\pix\aidFood.jpg' size='5' align='center'/><br/><br/>
	<t align='center' size='1.5'>Humanitarian Aid</t><br/><br/>
	<t align='center' size='1.5' color='#01df01'>Delivered</t><br/><br/>
	The food has been delivered to the population that has requested it. This is a small but important step towards the stabilization of the area.
	<br/>Good job everyone.<br/><br/>At the moment, the population %1 you.<br/>   ", _judgement];

[message,"hintThis"] spawn BIS_fnc_MP;

_aidmrk setMarkerColor "ColorGreen";
_aidmrk setMarkerText " Food Delivered";
