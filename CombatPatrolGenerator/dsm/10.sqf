...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////
////	Enemy Mortar small FOB
////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////



private["_pos","_pos2","_pos3","_pos4","_barrier1","_barrier2","_barrier3","_barrier4","_barrel1","_mrk","_counter", "_gunner", "_grp"];
...
{
	_pos = [cpg_v_cpos, cpg_side_adder, (1800*cpg_side_mult), 4, 0, 0, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
...
{
	_pos = [cpg_v_cpos, 0, 1600, 4, 0, 0, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
};
...
_barrel1 = createVehicle ["Land_MetalBarrel_F", [(_pos select 0) - 1, (_pos select 1) - 1.5], [], 0, "CAN_COLLIDE"];
_ammo1 = createVehicle ["Box_East_AmmoOrd_F", [(_pos select 0) + 2, (_pos select 1) + 2.5], [], 0, "CAN_COLLIDE"];
...
_mortar = createVehicle ["O_Mortar_01_F", [(_pos select 0) + 2, (_pos select 1)], [], 0, "NONE"];
_gunner = _grp createUnit ["O_Soldier_F", [(_pos select 0) + 2.5, (_pos select 1)], [], 0, "NONE"];
_gunner moveInGunner _mortar;
_gunner assignAsGunner _mortar;
_mortar setVehicleLock "LOCKED";
_mortar execVM "mortar\mortar.sqf";

cpg_v_enemynr = cpg_v_enemynr + (count units _grp);
nul = [leader _grp, _mrk, "nofollow", "spawned"] execVM "scripts\UPSMON.sqf";
_gunner setvariable ["raven_side_mission_group", 1];
...
if (side_mission_show_markers == 1) then
{
	...
	_mrk setMarkerText " Neutralize Mortar Site";
	_mrk setMarkerSize [1, 1];
	_mrk setMarkerPos _pos4;
};


[[[[["TaskDSM_10","Suppress Mortar Site","Suppress Mortar Site<br/><br/>Enemy forces have set up a small Mortar Site, threatening our land operations in that area.<br/><br/>Suppress the Mortar Site by eliminating the mortar operator and demolishing the Site itself."]]],"shk_taskmaster.sqf"],"BIS_fnc_execVM",false,true] spawn BIS_fnc_MP;
...
<t align='center' size='1.5'>Suppress Mortar Site</t><br/><br/>
<t align='center' size='1.5' color='#08b000'>Assigned</t>
<br/><br/>
Enemy forces have set up a small Mortar Site, threatening our land operations in that area.<br/><br/>
Suppress the Mortar Site by eliminating the mortar operator and demolishing the Site itself.<br/>   ";
...
if ((persistent_module_on) == 1) then
{
	...
	["CPG_database", "Side Missions", _string, 10]  call iniDB_write;
...
waitUntil { sleep 5; !alive _gunner; !alive _barrier1; !alive _barrier2; !alive _barrier3; !alive _barrier4 };
...
message = parseText format ["<br/><img image='CombatPatrolGenerator\sm\Tier1.jpg' size='5' align='center'/><br/><br/>
	...
	The enemy Mortar Site has been neutralized: our land operations in the area are now considerably safer.
