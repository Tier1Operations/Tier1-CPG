...
{
	_pos = [cpg_v_cpos, cpg_side_mult, (2500*cpg_side_mult), 15, 0, 0, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_check = _pos isflatempty [ 12, 1, 0.2, 25, 0, false, objNull]; 
	_counter = _counter + 1;
...
if (_counter < 10000) then 
{
	...
	_barrier1 = createVehicle ["Land_HBarrier_5_F", [(_pos select 0) + 18, (_pos select 1) + 8], [], 0, "CAN_COLLIDE"];
	_barrier1 setdir 90;
	_barrier1 setvectorup (surfacenormal _pos);
	_barrier1 = createVehicle ["Land_HBarrier_5_F", [(_pos select 0) + 18, (_pos select 1) - 4], [], 0, "CAN_COLLIDE"];
	_barrier1 setdir 90;
	_barrier1 setvectorup (surfacenormal _pos);
	...
	_barrier4 = createVehicle ["Land_HBarrier_5_F", [(_pos select 0) + 4, (_pos select 1) - 20], [], 0, "CAN_COLLIDE"];
	_barrier4 setvectorup (surfacenormal _pos);
	_barrier4 = createVehicle ["Land_HBarrier_5_F", [(_pos select 0) - 8, (_pos select 1) - 20], [], 0, "CAN_COLLIDE"];
	_barrier4 setvectorup (surfacenormal _pos);
	...
	_poshouse = [_pos, 25, 75, 15, 0, 5, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_house = createVehicle ["Land_Cargo_House_V1_F", _poshouse, [], 0, "CAN_COLLIDE"];
	_poshouse = [_pos, 25, 100, 15, 0, 5, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_house = createVehicle ["Land_Cargo_House_V1_F", _poshouse, [], 0, "CAN_COLLIDE"];
	_poshouse = [_pos, 25, 100, 15, 0, 5, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_house = createVehicle ["Land_Cargo_House_V1_F", _poshouse, [], 0, "CAN_COLLIDE"];
	_poshouse = [_pos, 25, 50, 15, 0, 5, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_house = createVehicle ["Land_FieldToilet_F", _poshouse, [], 0, "CAN_COLLIDE"];
	_poscomms = [_pos, 25, 50, 15, 0, 5, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
	_comms = createVehicle ["Land_Communication_F", _poscomms, [], 0, "CAN_COLLIDE"];
	...
	{
		_mrk = createMarker [format["main_mission_%1",cpg_main_missions], _pos4];
