...
_air1 = _grp createUnit ["O_Soldier_AA_F", _pos, [], 0, "NONE"];
_air2 = _grp createUnit ["O_Soldier_AA_F", _pos, [], 0, "NONE"];
_air3 = _grp createUnit ["O_Soldier_AA_F", _pos, [], 0, "NONE"];
...
if (side_mission_show_markers == 1) then
{
	...
	_mrk setMarkerText " Neutralize AA Site";
	_mrk setMarkerSize [1, 1];
	_mrk setMarkerPos _pos4;
};


[[[[["TaskDSM_9","Suppress AA Site","Suppress AA Site<br/><br/>Enemy forces have set up a small AA Site, denying us the possibility of air operations in that area.<br/><br/>Suppress the AA Site by eliminating the AA operators."]]],"shk_taskmaster.sqf"],"BIS_fnc_execVM",false,true] spawn BIS_fnc_MP;
...
<br/><br/>
Enemy forces have set up a small AA Site, denying us the possibility of air operations in that area.<br/><br/>
Suppress the AA Site by eliminating the AA operators.<br/>   ";
...
message = parseText format ["<br/><img image='CombatPatrolGenerator\sm\Tier1.jpg' size='5' align='center'/><br/><br/>
	...
	The enemy AA Site has been neutralized: our air operations in the area can now be restored.
