...
_triggerpos = [_centerPos, 0, 2000, 4, 0, 0, 0, cpg_v_blacklist, cpg_v_dpos] call BIS_fnc_findSafePos;
_dummypad = createVehicle ["Land_HelipadEmpty_F", _triggerpos, [], 0, "CAN_COLLIDE"];
	
waitUntil { ([getPosATL (_dummypad), 500, true, "count"] call custom_nearestPlayers) > 0 };
